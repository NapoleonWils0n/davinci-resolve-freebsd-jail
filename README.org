...
Add the your hostname from the jail to the hosts file in the ubuntu jail \\
...
Note this section is for running Davinci Resolve as an X11 application \\
skip this step if you are running resolve as a wayland application
...
uncomment fstab wayland section
